...
#ifndef DELAY_US
#define DELAY_US(us) delay_us_blocking(us)
#endif
...
// Configuration table
I2C_LCD_CfgParam_t I2C_LCD_CfgParam[I2C_LCD_MAX];

void I2C_LCD_Config(uint8_t I2C_LCD_InstanceIndex, I2C_HandleTypeDef* hi2c, uint8_t address7bit, uint8_t num_rows)
{
	I2C_LCD_CfgParam[I2C_LCD_InstanceIndex].I2C_Handle = hi2c;
	I2C_LCD_CfgParam[I2C_LCD_InstanceIndex].I2C_LCD_Address = address7bit;
	I2C_LCD_CfgParam[I2C_LCD_InstanceIndex].I2C_LCD_nRow = num_rows;
}
...
static void I2C_LCD_EnableDwtCycleCounter(void)
{
